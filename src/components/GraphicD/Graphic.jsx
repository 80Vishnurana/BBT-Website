        ...
        <>
            ...
            <Box sx={{ px: { xs: 2, md: 3, lg: 10, }, }} >
                <Box sx={{ px: { xs: 0, md: 1, lg: 5 }, py: { xs: 1, md: 2, lg: 4 }, display: "flex", flexDirection: { xs: "column", lg: "row" }, }}>
                    ...
                    <Box pl={1} sx={{ pt: { xs: 3, lg: 3 }, height: { xs: "320px", md: "400px", lg: "400px" }, width: { xs: "80vw", md: "100vw", lg: "350vw" } }}><img style={{ boxShadow: "15px 15px 5px black" }} src="graphicdesign.jpg" alt="" height={"100%"} width={"100%"} />
                    </Box>
                </Box>
            </Box>
            <Box sx={{ pl: { xs: 1, lg: 15 }, display: "flex" }}>
                ...
                <Typography variant='h5' sx={{ fontWeight: "600", fontFamily: "sans-serif", pb: 3 }}>
                    ...
                    Benefits you get from Graphic designing:
                </Typography></Box>

            <Box display={"flex"} sx={{ px: { xs: 2, lg: 12 }, backgroundColor: "rgb(236, 240, 247)", py: 12 }}>
                <Box sx={{ height: "60vh", width: "120%" }}>
                    <img style={{ borderRadius: "1rem" }} src="../public/graphicincrement.jpg" alt="" height={"100%"} width={"100%"} />
                </Box>
                    ...
                    <Box sx={{ ml: 5 }}  >
                        ...
                        <Paper sx={{ height: "60vh", borderRadius: "1rem", p: 2, boxShadow: 4 }}>
                            ...
                            <Box sx={{ display: "flex", px: 1, }}>
                                ...
                                <Box>
                                    <Typography variant='h6' sx={{ fontFamily: "sans-serif", py: 1, fontWeight: 500 }}>More attractive and attentive
                                    </Typography>
                            ...
                            <Box sx={{ display: "flex", px: 1, pt: 2 }}>
                                ...
                                <Box>
                                    <Typography variant='h6' sx={{ fontFamily: "sans-serif", py: 1, fontWeight: 500 }}>Increase viewer interaction
                                    </Typography>
            ...
            <Box display={"flex"} sx={{
                ...
                <Box sx={{ height: "70vh", width: "150%" }}>
                    <img style={{ borderRadius: "1rem" }} src="../public/plantgraphic.jpg" alt="" height={"100%"} width={"100%"} />
                </Box>
            </Box>
            ...
            <Box display={"flex"} sx={{
                ...
                <Box sx={{ height: "45vh", width: "150%" }}>
                    <img style={{ borderRadius: "1rem" }} src="../public/glowinggraphic.jpg" alt="" height={"100%"} width={"100%"} />
                </Box>
                <Box>
                    <Box sx={{ ml: 5 }}>
